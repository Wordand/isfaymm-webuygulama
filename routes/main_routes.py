...
def cerez_politikasi():
    return render_template("pages/cerez_politikasi.html")
...
def sitemap_xml():
    ...
    priority_map = {
        ...
        'indirimlikurumlar_seo.teblig_ornekleri': '0.8',
...
@bp.route("/mevzuat/his")
def his(): return render_template("pages/his.html")
